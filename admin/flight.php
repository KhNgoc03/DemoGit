...
<div class="container mt-0">
  <div class="row">
    ...
    ?>
      ...
      <h1 class="text-secondary text-center">THÊM CHUYẾN BAY</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">Ngày Khởi Hành</h5>
          </div>
          <div class="col">    
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">Ngày Trở Lại</h5>
          </div>          
          <div class="col">
        ...
        <div class="form-row">
          <div class="col">
            <div class="input-group">
                <label for="dura">Khoảng Thời Gian</label>
