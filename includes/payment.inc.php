...
if(isset($_POST['pay_but']) && isset($_SESSION['userId'])) {
    ...
    $sql = 'INSERT INTO PAYMENT (user_id, expire_date, amount, flight_id, card_no) 
        ...
        amount=VALUES(amount), expire_date=VALUES(expire_date)'; 
            ...
            if(!mysqli_stmt_prepare($stmt,$sql)) {
                ...
                if($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (mysqli_num_rows($result) === 0) {
                        // Không tìm thấy passenger_id trong passenger_profile
                        header('Location: ../payment.php?error=passengerid_not_found');
                        exit();
                    }    
