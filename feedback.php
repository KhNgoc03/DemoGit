...
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidemail') {
      ...
      echo"<script>alert('Cảm ơn nhận xét của bạn')</script>";
    } 
}
?>
<div class="container mb-4">
  <h1> <i class="far fa-comment-alt"></i> Nhận Xét</h1>
      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Ấn tượng đầu tiên của bạn là gì khi bạn vào trang web?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>Bạn biết về chúng tôi như thế nào?</option>
                <option >Công cụ tìm kiếm</option>
                <option >Truyền thông xã hội</option>
                <option >Bạn bè/Người thân</option>
                <option >Truyền miệng</option>
                <option >Tivi</option>
                <option>Khác</option>
              </select> 
            </div>                
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Có điều gì còn thiếu trên trang này?</label>     
...
<footer>
	...
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Được phát triển bởi nhóm</p>
</footer>