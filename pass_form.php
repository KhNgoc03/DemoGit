...
<main>
    ...
    <div class="col-md-12 main-col">
        <h1 class="text-center text-secondary">CHI TIẾT HÀNH KHÁCH</h1>  
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="firstname'.$i.'">Họ</label>
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="lastname'.$i.'">Tên đệm</label>
