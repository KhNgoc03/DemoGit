...
<?php
  if(isset($_GET['error'])) {
    if($_GET['error'] === 'sqlerror') {
      ...
      echo"<script>alert('Không có chuyến bay khứ hồi')</script>";
    } else if($_GET['error'] === 'mailerr') {
      echo"<script>alert('Lỗi email')</script>";
    }
  }
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">THANH TOÁN HÓA ĐƠN</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <span class="invalid-feedback">Nhập số thẻ hợp lệ gồm 12 đến 16 chữ số</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                    ...
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Nhập mã gồm 3 chữ số ở mặt sau</span>
                                <div class="input-group-append"><!-- log on to codeastro.com for more projects -->
                                    ...
                                    data-content="<div class='text-center one-card'>Mã gồm 3 chữ số ở mặt sau của thẻ.<div class='visa-mc-cvc-preview'></div></div>"
    ...
    if (form[0].checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       if (!regCardNo.test(CardNo)) {
        ...
        $("#cc-number").focus();
        alert(" Nhập số thẻ 10 đến 16 hợp lệ");
        return false;
      }
        ...
        $("#cc_exp").focus();
        alert(" Nhập ngày hết hạn hợp lệ");
        return false;
      }
