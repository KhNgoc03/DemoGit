...
if(isset($_GET['pwd'])) {
    if($_GET['pwd']=='updated') {
        echo "<script>alert('Mật khẩu của bạn đã được đặt lại!!');</script>";
    }
}    
?>
<?php
if(isset($_GET['error'])) {
    if($_GET['error'] === 'invalidcred') {
        echo '<script>alert("Thông tin xác thực không hợp lệ")</script>';
...
<div class="container mt-0">
  <div class="row">
    <div class="col-md-3"></div>
      ...
      <h1 class="text-secondary text-center">Đăng Nhập/ Đăng Kí</h1>
      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row">  
          ...
          <div class="col-10 mb-2">              
            <div class="input-group">
                <label for="user_id">Tên Tài Khoản/ Email</label>
        ...
        <!-- <div class="row mt-3">
          ...
          <a id="reset-pass" class="mr-5" href="reset-pwd.php"
              style="float: right !important;">Quên Mật Khẩu</a>        
          </div>         
        </div>    -->
        <div class="row mt-4">
          <div class="col">
