...
td {
  ...
  color: #424242;
        ...
        <?php if(isset($_POST['search_but'])) { 
          ...
          <div class="container-md mt-2">
            <h1 class="display-4 text-center text-light"
              >CHUYẾN BAY <br>Từ <?php echo $dep_city; ?> 
                 Đến <?php echo $arr_city; ?> </h1>
	...
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Được phát triển bởi nhóm 7</p>
</footer>